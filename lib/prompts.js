...
**Every sampled caption is prefixed with the year it was written and with what it was** — \`[2019] [post] finally ran the whole thing without stopping\`. Comments and messages are dated the same way. Read those years; they are the difference between describing a person and describing a person's archive.

The three kinds are \`[post]\`, \`[story]\` and \`[reel]\`, and they are different acts. A story overlay is a place name thrown up for a day and gone; a post caption is a considered public statement. **A difference in register between them is a finding** — somebody whose posts are careful and whose stories are unguarded is telling you something about how much of the effort is for an audience. Do not average across the tags.
...
Both of those fields read \`PsycheUser\`. The reader's handle and their name were substituted before this reached you, everywhere they appeared — the profile, their captions, their comments, their searches, their messages. Two other markers work the same way: \`PsycheEmail\` stands where an email address was, and \`PsychePhone\` where a phone number was, whoever they belonged to.
